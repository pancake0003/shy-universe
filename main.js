...
function animate (){
  ...
  meshes.planet1.scale.x = 0.5; meshes.planet1.scale.y = 0.5;meshes.planet1.scale.z = 0.5;
  meshes.planet2.position.x = 3*Math.sin(tick);
  meshes.planet2.position.y = 3*Math.cos(tick);
  meshes.planet2.scale.x = 2; meshes.planet2.scale.y = 2;meshes.planet2.scale.z = 2;
  meshes.planet3.position.x = 10*Math.sin(tick*2);
  meshes.planet3.position.y = 10*Math.cos(tick*2);
  meshes.planet3.scale.x = 0.2; meshes.planet3.scale.y = 0.2;meshes.planet3.scale.z = 0.2;
  ...
  meshes.planet4.scale.x = 8;meshes.planet4.scale.y = 8;meshes.planet4.scale.z = 8;
